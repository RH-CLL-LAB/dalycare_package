CCI = function(data, patientid = patientid, icd10 = diagnosis, exclude_CLL_score = FALSE, include_LC_score = FALSE) {
  #' @title
  #' CCI
  #' @author
  #' christian brieghel
  ...
  #' @example
  #' SDS_t_adm %>% CCI(icd10 = c_adiag) %>% select(patientid, CCI.score, CCI.2011.update)
  #' diagnoses_all %>% CCI() %>% select(patientid, CCI.score, CCI.2011.update)
  #' @references 
  #' Quan et al. Med Care. 2005;45:1130-9
  #' Quan et al. Am J Epidemiol. 2011;173:676-82
  
  print_color('\nQuan et al. Med Care. 2005;45:1130-9\nQuan et al. Am J Epidemiol. 2011;173:676-82', 'black')
